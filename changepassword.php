      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            <form name="changepassword" class="user" method="post" id="changepassword">
              <?php
              $cid = $_SESSION['uid'];
              ...
              ?>
                <div class="row">
                  ...
                  <div class="col-4 mb-3"> <input type="Password" class="form-control" id="Password" name="currentpassword" value="" required="true"></div>
                </div>
                <div class="row">
                  <div class="col-4 mb-3">New Password </div>
                  <div class="col-4 mb-3"> <input type="Password" class="form-control" id="newpassword" name="newpassword" value="" required="true"></div>
                </div>
                <div class="row">
