            ...
            <form class="user" method="post" action="">
              ...
              ?>
                ...
                <div class="row">
                  ...
                  <div class="col-8 mb-3">
                    <input type="number" class="form-control form-control-user" id="EmpContactNo" name="EmpContactNo" aria-describedby="emailHelp" value="<?php echo $row['EmpContactNo']; ?>">
                  </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-8  mb-3">
                    <input type="date" class="form-control form-control-user" value="<?php echo $row['EmpJoingdate']; ?>" id="jDate" name="EmpJoingdate" aria-describedby="emailHelp">
                  </div>
                </div>
                <div class="row">
