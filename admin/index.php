...
<head>
  ...
  <title>eTechnician Admin Login</title>
...
<body class="bg-gradient-primary">
  ...
  <div class="container">
    <!-- <h3 align="center" style="color: black; padding-top: 2%">eTechnicians</h3> -->
    <img src="http://localhost:8080/technician_management_app/img/orlogo.png" width="200px" style="margin-left: 40%" />
          ...
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block bg-login-image">
                <img src="http://localhost:8080/technician_management_app/img/admin.png" />
              </div>
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" method="post" action="">
                    <div class="form-group">
                      <input type="test" class="form-control" id="username" name="username" aria-describedby="emailHelp" required="true" placeholder="Enter username ...">
                    </div>
                    <div class="form-group">
