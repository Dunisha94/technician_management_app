            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-gray-800">View All Leaves</h1>
                        <a class="btn btn-primary" href="print.php">Print</a><br>
                                        ...
                                        <table class="table table-hover">
                                            <thead>
                                                <tr style="background-color: #3399ff; color: white;">
                                                    ...
                                                    <th class="fw-bold" scope="col">Reason fro Application </th>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        <th><?php echo $row['NoofLeaves']; ?></th>
                                                        <th><?php echo $row['LeaveType']; ?></th>
                                                        <th><?php echo $row['Reason']; ?></th>
                                                        <th><?php echo $row['CommenceOn']; ?></th>
                                                        <th><?php echo $row['EndOn']; ?></th>
                                                        <th><?php echo $row['ApplyDate']; ?></th>
                                                        <th><?php echo $row['LeaveStatus']; ?></th>
                                                    </tr>
                                                <?php
                                                }
                                                ?>
