...
?>
  ...
  <head>
    ...
    <title>eTechnician Employee Reset</title>
            ...
            <div class="card-body p-0">
              ...
              <div class="row">
                <div class="col-lg-6 d-none d-lg-block bg-login-image">
                  <img src="img/resetpassword.jpg" width="500" height="500" />
                </div>
                <div class="col-lg-6">
                  <div class="p-5">
                    ...
                    <form class="user" name="changepassword" method="post" id="changepassword">
                      <div class="form-group">
                        <input type="Password" class="form-control" id="newpassword" name="newpassword" value="" required="true" placeholder="Enter Your New Password" required="true">
                      </div>
                      <div class="form-group">
                        <input type="Password" class="form-control" id="confirmpassword" name="confirmpassword" value="" required="true" placeholder="Confirm Your Password" required="true">
                      </div>
